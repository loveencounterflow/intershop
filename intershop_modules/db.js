...
(function() {
  'use strict';
  var $, $async, $drain, $show, $watch, CND, Cursor, INTERSHOP, O, PTVR, SP, alert, assign, badge, db, debug, echo, has_duplicates, help, info, k, keys_of, last_of, log, pluck, pool, pool_settings, rpr, urge, warn, whisper;
