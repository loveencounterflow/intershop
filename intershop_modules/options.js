...
(function() {
  //###########################################################################################################
  var CND, alert, app, badge, debug, echo, help, info, ms_from_s_literal, respawn, rpc, rpr, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  ms_from_s_literal = function(s_literal) {
    var match;
    if ((match = s_literal.match(/^([0-9]+)\s*s$/)) == null) {
  ...
  respawn = {
    ...
    fork: process.env.intershop_rpc_respawn_fork === 'true',
