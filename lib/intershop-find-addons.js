(function() {
  'use strict';
  var CND, DATOM, FS, IORDER, PATH, alert, badge, cast, check, debug, declare, declare_check, echo, help, info, is_sad, isa, new_datom, resolve_pkg, rpr, type_of, types, urge, validate, warn, whisper;
  ...
  declare('ishop_addon_target', function(x) {
    return x === 'app' || x === 'rpc' || x === 'ignore' || x === 'support' || x === 'rebuild';
  });
...
does not exist`);
  ...
  this.find_addons = function() {
    var R, addons, deps, name, version;
  ...
  this._find_addons = function(R, location, XXX_path) {
    var addon, aoid, cwd, deps, error, file_id, ipj, package_json, path, ref, ref1, relpath, target, type, version;
...
//.........................................................................................................
    ...
    target = (R.order != null ? R.order : R.order = []);
    target = [...target, ...deps];
