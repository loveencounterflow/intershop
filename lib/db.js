(function() {
  'use strict';
  var $, $async, $drain, $show, $watch, CND, Cursor, INTERSHOP, O, PTVR, SP, alert, assign, badge, db, debug, echo, has_duplicates, help, info, isa, keys_of, last_of, log, pluck, pool, pool_settings, rpr, type_of, types, urge, validate, warn, whisper;
