...
(function() {
  'use strict';
  var $, $async, CND, FS, NET, O, PS, RPCS, alert, badge, debug, echo, help, info, rpr, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.do_rpc = function(S, event) {
    var command, error, method, method_name, parameters, result;
    S.counts.rpcs += +1;
    ({
      command,
      method: method_name,
    ...
    if (method == null) {
      return this._write_a(S, 'error', `no such method: ${rpr(method_name)}`);
    }
    try {
      //.........................................................................................................
      ...
      debug('44938', error);
      S.counts.errors += +1;
      return this._write_a(S, 'error', error.message);
    }
    return this._write_a(S, command, result);
  };

  //-----------------------------------------------------------------------------------------------------------
  this._write_a = function(S, command, data) {
    var line;
