...
(function() {
  //###########################################################################################################
  var $, $async, CND, NET, PS, RPCS, alert, badge, config, debug, echo, help, info, rpc_host, rpc_port, rpr, urge, warn, whisper;
  ...
  this.listen = function(handler = null) {
    ...
    server = NET.createServer((socket) => {
      ...
      pipeline.push(this.$parse_signal());
    ...
    if (handler == null) {
      handler = () => {
        ...
        return help(`listening on ${family} ${host}:${port}`);
      };
    }
    //.........................................................................................................
    ...
    return $((event, send) => {
      ...
      switch (command) {
        ...
        case 'data':
          ...
          break;
        case 'rpc':
          this.do_rpc(S, channel, command, data);
          break;
        default:
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.do_rpc = function(S, channel, command, data) {
    var error, method, method_name, parameters, result;
    S.counts.rpcs += +1;
    ({
      method: method_name,
      parameters
    ...
    if (method == null) {
      return this._write_a(S, channel, 'error', `no such method: ${rpr(method_name)}`);
    }
    try {
      //.........................................................................................................
      ...
      debug('44938', error);
      S.counts.errors += +1;
      return this._write_a(S, channel, 'error', error.message);
    }
    return this._write_a(S, channel, command, result);
  };

  //-----------------------------------------------------------------------------------------------------------
  this._write_a = function(S, channel, command, data) {
    var line;
    line = JSON.stringify({
      channel,
      command,
